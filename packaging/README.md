...
```bash
scripts/build-arch-package.sh v0.6.3 /path/to/FFIV3DSaveEditor-v0.6.3-linux-x64 /tmp/packages
scripts/build-rpm-package.sh v0.6.3 /path/to/FFIV3DSaveEditor-v0.6.3-linux-x64 /tmp/packages
```
