...
```bash
scripts/build-arch-package.sh v0.6.4 /path/to/FFIV3DSaveEditor-v0.6.4-linux-x64 /tmp/packages
scripts/build-rpm-package.sh v0.6.4 /path/to/FFIV3DSaveEditor-v0.6.4-linux-x64 /tmp/packages
```
...
Installed files include `/usr/bin/ffiv3d-save-editor`, a desktop entry, a 256-pixel hicolor icon, AppStream metadata, the project LGPL/GPL texts, the upstream LGPL text, the supplemental MIT text, and the project's permission/notice documents.
