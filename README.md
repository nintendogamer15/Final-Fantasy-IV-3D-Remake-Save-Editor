...
This is a desktop, command-line, and interactive terminal editor for the PC/GOG/Steam Final Fantasy IV 3D Remake `SAVE.BIN` format. Version 0.6.2 is implemented in C# on .NET 10, with an Avalonia desktop interface for Windows and Linux.
